...
@section('content')
	...
	<div class="row info">
		<p>Your current configuration for this provision is the follow. This will be kept in order to properly display old transaction with this provision.</p>
		<p>The valid until date will be changed for previous month. Your new provision will have this month as a start date</p>
		<p>&nbsp;</p>
	</div>
	<div class="row">
		<div class="col-md-3">
			<div class="form-group">
				...
				{{$categories[$provision->category->id]}}
			</div>
		</div>
		<div class="col-md-3">
			<div class="form-group">
		...
		<div class="col-md-3">
			<div class="form-group">
				...
				{{$transactionTypes[$provision->transactionType->id]}}
			</div>
		</div>
	</div>
	<div class="row">
		<div class="col-md-3">
			<div class="form-group">
				...
				{{date('Y-m', strtotime($provision->start_at))}}
			</div>
		</div>
		<div class="col-md-3">
			<div class="form-group">
			...
			<div class="col-md-3">
				<div class="form-group">
					...
					<div class="input-group">
						...
						<input type="month" class="form-control" id="start_at" name="start_at" readonly="readonly" placeholder="{{trans('app.labels.value')}}" value="{{date('Y-m', strtotime('today'))}}">
					</div>
				</div>
			</div>
			<div class="col-md-3">
